...
#define scale2x_8_map(d1,d2,s1,s2,s3,m,c) scale2x_8_def(d1,d2,s1,s2,s3,c)
 ...
 * \param dst1 Second destination row, double length in pixels.
 */
static INLINE void scale2x_16_def(scale2x_uint16* dst0, scale2x_uint16* dst1, const scale2x_uint8* src0, const scale2x_uint8* src1, const scale2x_uint8* src2, unsigned count)
{
	/*assert(count >= 2);*/
	if (count < 1)
		return;
...
static INLINE void scale2x_16_map(scale2x_uint16* dst0, scale2x_uint16* dst1, const scale2x_uint8* src0, const scale2x_uint8* src1, const scale2x_uint8* src2, const scale2x_uint32 *map, unsigned count)
{
	/*assert(count >= 2);*/
	if (count < 1)
		return;
